...
### 线性变换的矩阵表达式
 - **线性变换的矩阵表达式**：在线性空间$V_n$ 中取一个基$\alpha_1,\alpha_2,\dots,\alpha_n$，这个基在线性变换T下的像：$T(\alpha_1,\alpha_2,\dots,\alpha_n)=(\alpha_1,\alpha_2,\dots,\alpha_n)A$ ，A称线性变换T在基$\alpha_1,\alpha_2,\dots,\alpha_n$下的矩阵。
	...
	- 🎯：通过基在线性变换T下的像，可确定唯一矩阵A，同样，矩阵A也可以确定唯一线性变换T。记$V_n$中任一元素$\alpha=\sum\limits_{i=1}^{n} x_i a_i$ ，$T(\alpha)=T(\sum\limits_{i=1}^n x_i a_i)=\sum\limits_{i=1}^n x_i T(a_i)=(T(a_1),T(a_2),\dots,T(a_n))(x_1,x_2,\dots,x_n)^T=(a_1,a_2,\dots,a_n)A(x_1,x_2,\dots,x_n)^T$  
